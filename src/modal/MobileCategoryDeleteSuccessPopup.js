...
export default function MobileCategoryDeleteSuccessPopup({callback, content}) {
  ...
  return (
    <div>
      ...
      >
        <Fade in={open}>
          <Box sx={style}>
              <Row style={{width:"90%", margin: "10px auto", height:'50px'}}>
                <IconCloseView >
             ...
             <Row style={{width:"100%", background:"#E3E3E3", height:'45px',borderBottomRightRadius: "10px",
              ...
              <Row style={{width:"60%", margin:"0 auto", display:"flex", justifyContent:"space-between"}}>
                <ButtonBox>
                ...
                <ButtonBox>
                  <CheckText onClick={handleCloseCancel}>
                    취소
                  </CheckText>
                </ButtonBox>
