...
import { CreateBirthday } from '../service/MemoService';
...
export default function MobileBirthdayadd({callback}) {
  ...
  const _handleadd = async()=>{
    ...
    const MEMOTYPE = CurrentMenu.BIRTHDAY;
  

    const birthday = await CreateBirthday({ NAME, DATE, USERS_ID, MEMOTYPE })
        ...
        <Fade in={open}>
          <Box sx={style}>
            ...
            <BetweenRow style={{ width:"85%", margin: "20px auto", }}>
                <div style={{fontSize:"18px", fontWeight:900, color:"#131313", fontFamily:'Pretendard-SemiBold'}}>기념일추가</div>
            ...
            <Layer>
              ...
              <div style={{marginleft:5}}>
               기념일을 저장해주세여. 구해줘 알바에서 잊지않고 기념일이 다가오기 전에 알람 해드릴깨요
              </div>
            </Layer>
