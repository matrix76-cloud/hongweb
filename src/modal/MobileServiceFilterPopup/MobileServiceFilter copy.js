        ...
        <Fade in={open}>
          <Box sx={style}>
              ...
              <BetweenRow style={{width:"80%", margin: "20px auto", }}>
                <div style={{fontSize:"18px", fontWeight:900, color:"#131313", fontFamily:'Pretendard-SemiBold'}}>홍여사 도움 선택</div>
            ...
            <ApplyItem >
                <div style={{dispaly:"flex", alignItems:"center", justifyContent:"center", width:"80%"}}>   
                    <ApplyButton onClick ={_handlefilterapply}><ApplyButtonText>적용하기</ApplyButtonText></ApplyButton>
                </div>
            </ApplyItem>
          </Box>
        </Fade>
