...
import ExpireDateSelectormin from '../components/ExpireDateSelectormin';
...
console.log("MATRIX LOG : MobileRecipeadjust : adjustfreezeitem:", adjustfreezeitem)
  ...
  const _handleExpireChange = (data)=>{
    setLast(data);    
    setRefresh((refresh)=> refresh +1);
  }
  return (
        ...
        <Fade in={open}>
          <Box sx={style}> {/* 기존 style 사용 가능 */}
            ...
            <Row style={{ width:"85%", margin:"15px auto"}}>
              ...
              <ExpireDateSelectormin onChange={_handleExpireChange} lastdate={lastdate} />
