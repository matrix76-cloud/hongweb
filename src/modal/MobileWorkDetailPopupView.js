...
import WorkCalendarInfoView from '../components/WorkCalendarInfoView';
...
export default function MobileWorkDetailPopupView({callback, workitems, startdate}) {
        ...
        <Fade in={open}>
          ...
          <Box sx={style}>
            ...
            <Row style={{width:"90%", margin:"15px auto"}}>
              ...
              <WorkCalendarInfoView workitems={workitems} selectstartorigin={startdate} />
