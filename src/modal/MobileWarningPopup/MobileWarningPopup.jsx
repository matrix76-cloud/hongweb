 ...
 * 호출 방식은 그대로: <MobileWarningPopup callback={...} content="..." />
 */
export default function MobileWarningPopup({ callback, content }) {
  ...
  return <MobileConfirmPopup alertonly icon="warning" message={content} onConfirm={handleClose} />;
}
