...
import MobileTourCourseTrace from '../components/MobileTourCourseTrace';
...
export default function MobileTourTracePopup({ callback, COURSEITEM , eventname}) {
  ...
  return (
    <div>
      ...
      >
        <Fade in={open}>
          <Box sx={style}>
            <MobileTourCourseTrace item={COURSEITEM} name ={eventname}/>
