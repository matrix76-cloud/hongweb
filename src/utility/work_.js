...
export const Requestcleanmessages =[
    ...
    {type:"response", responseshow : true, show:false, index:2, requesttype:REQUESTINFO.TARGET,  result:""},
  
    {
      ...
      {type:"response", responseshow : true, show:false, index:4, requesttype:REQUESTINFO.TARGETAREA,  result:""},
    ...
    {type:"response", responseshow : true, show:false, index:6, requesttype:REQUESTINFO.PERIOD,  result:""},
