...
[{
	...
	CONTENT :[
        ...
        "주식회사 홍컴즈(이하 “회사”라 한다)는 귀하의 개인정보보호를 매우 중요시하며, 『개인정보보호법』상의 개인정보보호규정을 준수하고 있습니다. “회사”는 개인정보처리방침을 통하여 귀하께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.",
...
export const USELAW = [
    {
        ...
        LABEL : "제1조 (목적)",
        CONTENT :[
        '이 약관은 주식회사 홍컴즈(이하 “회사”라 한다)가 운영하는 생활 도움 매칭 플랫폼 「구해줘 홍여사」(이하 “플랫폼”이라 한다)에서 제공하는 서비스(이하 “서비스”라 한다)를 이용함에 있어 “회사”와 “이용자”의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.' +
    ...
    },
    {
        ...
        '고객센터 운영시간은 아래와 같이 규정합니다.홍여사 고객센터 운영시간 : 오전 9시부터 오후 6시까지고객행복센터 이용불가 시간에는 Kakao > 친구목록 ‘힐리 고객센터’에서 문의를 받고 있으며 순차적으로 답변이 진행됩니다.',
        ],
        OPEN : false
    },    {
        INDEX :'09.',
...
export const GPSLAW = [
    {
        ...
        LABEL : "제1조 (목적)",
        CONTENT :[
        '본 약관은 홍컴즈(이하 “회사"라 한다)가 제공하는 위치기반서비스(이하 “서비스“라 한다)를 이용함에 있어 “회사”와 “서비스”를 이용하고자 하는 자(이하 “이용자"라 한다)의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.',
    ...
    },
    {
        ...
        '\n'+'상 호 : 주식회사 홍컴즈' +
        '\n'+'사업자등록번호 : 480-86-03245' +
        '\n'+'대 표 자 : 이행렬' +
        '\n'+'주 소 : 서울특별시 서초구 사임당로8길 13, 4층 402-제이681호(서초동)' +
        '\n'+'대표전화 : 070-4544-7684',
        ],
        OPEN : false
    },
