...
import PCAttendanceEventcontainer from "../../container/PCmain/PCAttendanceEventcontainer";
...
import PCRulletEventcontainer from "../../container/PCmain/PCRulletEventcontainer";
...
const PCRulletEventpage =() =>  {
  ...
  return (
    ...
    <PCLayout main={true} name={''} height={80}>
        <PCRulletEventcontainer />
    </PCLayout>
  );

}

export default PCRulletEventpage;
