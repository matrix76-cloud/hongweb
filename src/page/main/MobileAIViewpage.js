...
import MobileAILayout from "../../screen/Layout/Layout/MobileAILayout";

import MobileAIViewcontainer from "../../container/main/MobileAIViewcontainer";
...
const MobileAIViewpage =() =>  {
  ...
  return (
    ...
    <MobileAILayout>
      <MobileAIViewcontainer />
    </MobileAILayout>
  );

}

export default MobileAIViewpage;
