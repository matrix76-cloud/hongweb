...
import MobileLifeFoodDrugDetailcontainer from "../../container/main/MobileLifeFoodDrugDetailcontainer";
...
const MobileLifeFoodDrugDetailpage =() =>  {
  ...
  return (
    <MobileCommunityContentLayout2 name={location.state.name} type={MOBILEMAINMENU.COMMUNITYMENU} image=''>
      <MobileLifeFoodDrugDetailcontainer name={location.state.name} index={location.state.index}  search={location.state.search}
        data={location.state.item}    />
    </MobileCommunityContentLayout2>
  );
}

export default MobileLifeFoodDrugDetailpage;
