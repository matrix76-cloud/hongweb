...
import MobileWorkerMapcontainer from "../../container/main/Mobileworkermapcontainer";
import MobileWorkerMapLayout from "../../screen/Layout/Layout/MobileWorkerMapLayout";
...
const MobileWorkerMappage =() =>  {
  ...
  return (
    ...
    <MobileWorkerMapLayout type={MOBILEMAINMENU.HOMESEARCHMENU}>
        <MobileWorkerMapcontainer />
    </MobileWorkerMapLayout>
  );

}

export default MobileWorkerMappage;
