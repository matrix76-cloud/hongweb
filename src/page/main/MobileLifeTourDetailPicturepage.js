...
import MobileLifeTourAutoPicturecontainer from "../../container/main/MobileLifeTourDetailPicturecontainer";
import MobileLifeTourDetailPicturecontainer from "../../container/main/MobileLifeTourDetailPicturecontainer";
...
const MobileLifeTourDetailPicturepage =() =>  {
  ...
  return (
    <MobileCommunityLayout name={location.state.name} type={MOBILEMAINMENU.COMMUNITYMENU} image=''>
        <MobileLifeTourDetailPicturecontainer name={location.state.name} index={location.state.index} 
        items={location.state.items}    />
    </MobileCommunityLayout>
  );
}

export default MobileLifeTourDetailPicturepage;
