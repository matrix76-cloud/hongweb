...
import MobileWorkMapconfigcontainer from "../../container/main/MobileWorkMapconfigcontainer";
...
const MobileWorkMapconfigpage =() =>  {
  ...
  return (
    ...
    <MobileWorkMapconfigcontainer TYPE={location.state.TYPE}/>
    </div>
...
export default MobileWorkMapconfigpage;
