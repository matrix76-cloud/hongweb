...
const MobileLifeMedicalDrugDetailcontainer=({containerStyle, data, search}) =>  {
 ...
 */
  ...
  const _handleprev = () => {
    navigate("/Mobilecommunitycontent", { state: { name: MEDICALMENU.MEDICALMEDICINE, search : search } });
  }
  ...
  return (
    ...
    <Container style={containerStyle}>
      ...
      <BetweenRow onClick={_handleprev}  style={{ width: "100%", paddingTop: 10, position: "fixed", backgroundColor: '#fff', zIndex: 10,height:40 }}>
      ...
      <Column style={{ alignItems: "flex-start", marginTop:80 }}>
        <Row style={{ width: "90%", margin:"0 auto" }}>
          ...
          <Column style={{ width: '70%', alignItems: "flex-start", paddingLeft: 10 }}>
...
export default MobileLifeMedicalDrugDetailcontainer;
