      ...
      <Container style={containerStyle}>
        ...
        <Column style={{marginBottom:30}}>
            ...
            <style>{Contentstyle}</style>
              ...
              <div class="section-title">행복한 여가생활을 위한 생활 팁</div>
              ...
              <BetweenRow style={{width:"100%"}}>
                <CourseLayout>
                  <Column style={{ fontSize: () => getFontSize(14), color: '#fff', marginTop:15 }}>
                    ...
                    {/* <Column style={{marginTop:10}}>
                      <div style={{ fontSize: () => getFontSize(14), color: '#fff' }}>구해줘 홍여사 AI가 추천드리는</div>
                      <div style={{ fontSize: () => getFontSize(14), color: '#fff' }}>전국관광코스 제공</div>
                    </Column> */}
                  </Column>

                  
                  <Column style={{ width: "100%", margin : '10px auto' }}>
                    <img src={imageDB.convenience} style={{ width: 100, height: 100 }} onClick={() => { _handlemenu(TOURISTMENU.TOURCOURSE) }} />
                  </Column>

                  <div style={{width:"100%", marginBottom:15}}>
                    {/* <MobileLifeDisplayTourCourse /> */}
                    <ButtonEx containerStyle={{ fontSize: () => getFontSize(14), marginTop: 15, height: "47px" }} onPress={() => { _handlemenu(TOURISTMENU.TOURCOURSE) }} width={'90'} radius={'4px'} bgcolor={'#3469f3'} color={'#fff'} text={'더 보러가기'} />
                  </div>
                </CourseLayout>

                <RegionLayout>

                  <Column style={{ fontSize: () => getFontSize(14), color: '#131313', marginTop: 15 }}>
                    <div style={{ fontSize: () => getFontSize(16), color: "#131313", fontFamily: "Pretendard-SemiBold" }}>문화축제 정보</div>
                  </Column>

                  <BetweenRow style={{width:"65%", margin:"25px auto 0px"}}>
                    <img src={imageDB.region1} style={{width:40}} />
                    <img src={imageDB.region2} style={{ width: 40 }} />
                  </BetweenRow>

                  <Row>         
                    <img src={imageDB.region5} style={{ width: 60 }} /> 
                  </Row>
                  <Column style={{ width: "100%", margin: "0px auto 15px" }}>
                    <ButtonEx containerStyle={{ fontSize: () => getFontSize(14), marginTop:0, height: "47px" }} onPress={() => { _handlemenu(TOURISTMENU.TOURFESTIVAL) }} width={'90'} radius={'4px'} bgcolor={'#3469f3'} color={'#fff'} text={'문화축제 정보 보기'} />
                  </Column>
                </RegionLayout>
              </BetweenRow>
                ...
                <div style={{ width: "100%", margin: "15px auto 0px" }}>
                  <div style={{ backgroundColor: "#f0f0f0", width: "100%", borderRadius: 10 }}>
                    <Row style={{color:"#131313", fontSize: () => getFontSize(16),paddingTop:15, paddingBottom:5, fontFamily:"Pretendard-SemiBold"}}>
                      <div>기타 서비스</div>
                    </Row>
                    ...
                    <div style={{ padding: "0px 10px 10px 10px" }}>
                      ...
                      <Row style={{ width: '100%' }}>
                        ...
                        <LeisureBox4 onClick={() => { _handlemenu(CONVENIENCEMENU.CONVENIENCECAMPING) }} >
                          ...
                          <LeisureDesc>{'캠핑장정보를 한눈에 볼수 있도록 제공'}</LeisureDesc>
                ...
                <Guide style={{ marginTop: 20, paddingBottom: 0, justifyContent: "space-between" }}>
                  <div style={{fontSize: () => getFontSize(16)}}>관광지 사진</div>
