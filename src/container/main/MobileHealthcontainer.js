...
import MobileWaterCard from "../../components/MobileWaterCard";
import MobileEtcCard from "../../components/MobileEtcCard";
...
const MobileHealthcontainer =({containerStyle}) =>  {
      ...
      <Container style={containerStyle}>
        ...
        <Column style={{marginBottom:30}}>
            ...
            {/* <style>{Contentstyle}</style> */}
              ...
              }}>활력있는 건강생활을 위한 생활 팁</SectionTitle>
...
export default MobileHealthcontainer;
