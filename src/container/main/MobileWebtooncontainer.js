...
import MobileWebtoonPopup from "../../modal/MobileWebtoonPopup";
...
const MobileWebtooncontainer = ({image, name }) =>{
  ...
  return (
    <Container>
      <MobileWebtoonPopup callback={mobilepicturepopupclose} image={image} name={name} />
    </Container>
  );
};

export default MobileWebtooncontainer;