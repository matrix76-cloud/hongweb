...
const MeuItems = [
  ...
  {url :"/PCGuideInfo", value:"알아보기",menulabel:"구해줘 알바 알아보기"},
  {url :"/PCSumpolicy", value:"이용약관",menulabel:"구해줘 알바 이용약관"},
]
  ...
  return (
    ...
    <PCHeader height={height}>
      ...
      <TwoContainer id="twoheader">
        <BetweenRow style={{paddingLeft : '20px', width:'100%', margin:"0 auto", height:60}} id="twosubheader">
          <LogoLayer onClick={()=>{}}>
            <Row>      
              <img src={imageDB.Whitelogo} width={25} height={25} />
              <Link to="/PCGate">
                <div style={{ color:"#FFF",fontFamily:"Pretendard-SemiBold",display:"flex", justifyContent:"center", alignItems:"center", paddingLeft:10}}>구해줘 알바</div>
              </Link>
            </Row>
          </LogoLayer>
          ...
          <ButtonLayer>
          {
            MeuItems.map((data, index)=>(
              ...
              >
              {
                ...
                className={`whitemenu-item ${hoveredIndex !== null && hoveredIndex !== index ? 'dimmed' : ''}`}
                    >
