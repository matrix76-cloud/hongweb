...
const MobilePrevheader2 = ({callback, name}) => {
  ...
  const _handleprev = () =>{
    console.log("TCL: _handleprev -> location.pathname ", location.pathname );
  ...
  return (
    ...
    >
      ...
      <div style={{paddingLeft:15, display:"flex", fontWeight:700, fontSize:'20px', color:"#131313"}}>
       <div>{name}</div>
      </div>
...
export default MobilePrevheader2;
