...
const CommonHeaderWork2 = ({ onLocationClick, onFilterClick, onBackPressed, filterSummary, onFilterReset }) => {
...
export default CommonHeaderWork2;

// ✅ CommonHeaderMap.jsx (CommonHeaderWork2) - HeaderWrapper 교체
