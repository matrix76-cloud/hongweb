...
const LifeTourCountry =({containerStyle, items}) =>  {
console.log("TCL: LifeTourCountry -> items", items)
 ...
 */
  ...
  const [currentloading, setCurrentloading] = useState(true);
    ...
    const _handleControlFromMap = (id, items) =>{
        ...
        let FindIndex = findIndex(id, items);
      ...
      }
      {
        item != null && <PopupWorkEx>
          ...
          <div style={{display:"flex", flexDirection:"row",width:"100%" }}>
            ...
            <TableLayout>
            <Table class="work-table" style={{marginTop:20, height:500, border:"none"}}>
              <tbody>
                <tr>
                  <td>유적지 번호</td>
                  <td>{item.appnNo }</td>
...
export default LifeTourCountry;
