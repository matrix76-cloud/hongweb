...
const MobileWaterHistory =({containerStyle}) =>  {
  ...
  return (
    <Container style={containerStyle}>     
    {
      ...
      : (
            <HeaderWrapper> 
              <HeaderLayer>
                <Column style={{ paddingTop: 10, width: "100%", margin: "0 auto", color: "#fff", lineHeight: 2, height: 50 }}>
                  <BetweenRow style={{ width: "100%", margin: "0 auto" }}>
                    <div style={{ display: "flex", fontSize: '18px', color: "#fff", alignItems: "center", paddingLeft: 15 }}  onClick={_handleprev} >
                      <img src={imageDB.whiteprev} style={{ height: 24 }}/>
                      <div style={{ paddingLeft: 10, fontSize: () => getFontSize(20), fontFamily: "Pretendard-SemiBold", color: "#fff" }}>{'수분섭취 기록'}</div>
                    </div>

                    <div style={{ display: "flex", fontSize: '18px', alignItems: "center", paddingRight: 25 }}>
                      {/* <KakaoShare height={20} width={20} text={'[구해줘 홍여사] 수분섭취 관리기록을 공유합니다'} url={`https://honglady.co.kr/MobileWaterHistoryView?id=${user.USERS_ID}`} /> */}
                    </div>
                  </BetweenRow>
                </Column>
                <TagLayer>
...

              {
                ...
                <>
                  ...
                  <div style={{ fontSize: () => getFontSize(20), paddingLeft: 10, color: '#fff', margin: '10px 0px' }}>
                    기록
                  </div>
                      ...
                      wateritems.map((data, index) => (
                        ...
                        <RecordBox key={index}>
                          <RecordLayer>
                            ...
                            <Column>
                              <FaRegTrashAlt color={'white'} onClick={()=>{_handleDelete(data)}}/>
                            </Column>
                          </RecordLayer>
...

              {
                menu == CurrentMenu.WEEK && <>
                  <Row style={{width:"90%", margin:"20px auto 20px"}}>
...
export default MobileWaterHistory;
