...
import { CONFIGMOVE, MOBILEMAINMENU } from "../utility/screen";
...
const MobileListBanner =({containerStyle,backgroundcolor,button=false,buttonType="1",
  top='0px',
 ...
 */
  ...
  const _handlehong = () =>{
    ...
    navigate("/Mobilemap" ,{state :{WORK_ID :"", TYPE : MOBILEMAINMENU.HONGMENU}});
  }
  ...
  return (
    ...
    <Container backgroundcolor = {backgroundcolor} style={containerStyle}>
      ...
      <MainContent2>
      <RegistButton onClick={_handlehong}>등록된 일감 확인 하기</RegistButton>
      </MainContent2>
...
export default MobileListBanner;
