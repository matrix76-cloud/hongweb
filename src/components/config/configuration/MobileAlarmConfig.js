...
const MobileAlarmConfig =({containerStyle}) =>  {
    ...
    <Container style={containerStyle}>
      ...
      {loading == true  && <LottieAnimation containerStyle={LoadingCommunityStyle} animationData={imageDB.loading}
        ...
        <ConfigLabel>
          ...
          <div style={{paddingLeft:5}}>일감 알람 설정</div>
        </ConfigLabel>  
        <FlexWrap>
          {
        ...
        <Box height={160} style={{marginTop:15}} >   
           
        <ConfigLabel>

          <img src={imageDB.ic_myinfo_menu_hong} style={{ width: 25, height: 25 }} />
          <div style={{ paddingLeft: 5 }}>가격 알람 설정</div>
...
export default MobileAlarmConfig;
