...
const PCSupportWork =({containerStyle}) =>  {
  ...
  return (
    <Container style={containerStyle}>
      ...
      <Column margin={'0px auto;'} width={'100%'} style={{background:"#f9f9f9"}} >
       {currentloading == true ? (<LottieAnimation containerStyle={LoadingChatAnimationStyle} animationData={imageDB.loadinglarge}
