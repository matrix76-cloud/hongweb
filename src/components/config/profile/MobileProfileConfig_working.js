                        ...
                        <Row>
               
                          {
                            editable != false ? (<ConfigBtn>
                              <div onClick={_handleNameMove} >대화명설정</div>
              ...
              <Activity> 
                <div style={{padding:10}}>
                  <Row>
                    ...
                    <div style={{paddingLeft:10,fontSize: () => getFontSize(16)}}>집청소/다산동/2024.09.17</div>
                  </Row>
                ...
                <div style={{padding:10, fontSize: () => getFontSize(16)}}>
                  <div>견적금액 : 5만원대</div>
                </div>
              </Activity>
            </ActivityColumn> */}
                ...
                <BetweenRow style={{flexWrap:"wrap", width:"90%"}}>
                  {
                    BadgeItems.map((data, index)=>(
                      <Box onClick={()=>{_handleBadge(data)}}   >
                        ...
                        <div style={{ fontSize: () => getFontSize(12), color:"#131313", fontFamily:"Pretendard-SemiBold", marginTop:5}}>{data.name}</div>
                      </Box>
                    ))
                  }
                </BetweenRow>
